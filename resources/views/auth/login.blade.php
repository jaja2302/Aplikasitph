        ...
        <div class="w-full max-w-4xl mx-4">
            ...
            <div class="bg-white rounded-lg shadow-2xl overflow-hidden">
                <div class="md:flex">
                    ...
                    <div class="hidden md:block md:w-1/2 p-12 bg-white">
                        <div class="text-center">
                            <img src="{{ asset('images/CBIpreview.png') }}" alt="Company Logo" class="w-32 h-32 mx-auto mb-6">
                            <h2 class="text-2xl font-bold text-green-700 mb-1">Citra Borneo Indah</h2>
                            <p class="text-sm text-green-600 mb-4">Karya Nyata untuk Negeri</p>
                    ...
                    <div class="w-full md:w-1/2 p-8 bg-white">
                        <div class="md:hidden text-center mb-8">
                            ...
                            <h2 class="text-2xl font-bold text-green-700">Citra Borneo Indah</h2>
                        </div>
